...
React 18 includes a source useScreen implementation without a Beyond bundle-export marker. Do not treat its old usage examples as proof of public export availability.
